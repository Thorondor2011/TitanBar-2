...
-- colors
ComboBox.HighlightColor = Turbine.UI.Color( 1, 1, 0 );
ComboBox.SelectionColor = Turbine.UI.Color( 0.7, 0.6, 0.2 );
ComboBox.ItemColor = Turbine.UI.Color(1, 0.9, 0.5);
ComboBox.DisabledColor = Turbine.UI.Color( 0.4, 0.4, 0.4);
ComboBox.BlackColor = Turbine.UI.Color( 0, 0, 0);
ComboBox.BackHighlightColor = Turbine.UI.Color( 0.5, 0.5, 0.5, 0.5 );
--[[
ComboBox.HighlightColor = TitanBar.Color.gold;
ComboBox.SelectionColor = TitanBar.Color.rustedgold;
ComboBox.ItemColor = TitanBar.Color.nicegold;
ComboBox.DisabledColor = TitanBar.Color.lightgrey1;
ComboBox.BlackColor = TitanBar.Color.black;
ComboBox.BackHighlightColor = TitanBar.Color.lightgrey;]]
